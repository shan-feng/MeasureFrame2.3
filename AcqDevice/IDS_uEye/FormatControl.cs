...
namespace AcqDevice
{
    public partial class FormatControl : IControl
    {
        ...
        private void InitPixelformat()
        {
            ...
            {
                radioButtonGray8Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.Mono8, uEye.Defines.ColorConvertMode.Software);
                ...
                radioButtonGray12Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.Mono12, uEye.Defines.ColorConvertMode.Software);
                ...
                radioButtonGray16Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.Mono16, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonRaw8Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.SensorRaw8, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonRaw12Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.SensorRaw12, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonRaw16Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.SensorRaw16, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonRGB24Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.RGB8Packed, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonRGB32Normal.Enabled = isColorModeSupported(uEye.Defines.ColorMode.RGBA8Packed, uEye.Defines.ColorConvertMode.Software);
            ...
            radioButtonGray8Normal.Checked = colorMode == uEye.Defines.ColorMode.Mono8 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonGray12Normal.Checked = colorMode == uEye.Defines.ColorMode.Mono12 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonGray16Normal.Checked = colorMode == uEye.Defines.ColorMode.Mono16 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonRaw8Normal.Checked = colorMode == uEye.Defines.ColorMode.SensorRaw8 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonRaw12Normal.Checked = colorMode == uEye.Defines.ColorMode.SensorRaw12 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonRaw16Normal.Checked = colorMode == uEye.Defines.ColorMode.SensorRaw16 && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonRGB24Normal.Checked = colorMode == uEye.Defines.ColorMode.BGR8Packed && convertMode == uEye.Defines.ColorConvertMode.Software;
            ...
            radioButtonRGB32Normal.Checked = colorMode == uEye.Defines.ColorMode.BGRA8Packed && convertMode == uEye.Defines.ColorConvertMode.Software;
        ...
        private Boolean isColorModeSupported(uEye.Defines.ColorMode colorMode, uEye.Defines.ColorConvertMode colorConvertMode)
        {
            ...
            {
                if (uEye.Defines.ColorConvertMode.Software == colorConvertMode)
                {
                    return (converterMode & uEye.Defines.ColorConvertMode.Software) != uEye.Defines.ColorConvertMode.None ? true : false;
                }
        ...
        private void onPixelFormat_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (radioButtonRaw8Normal.Checked)
            {
                ...
                convertMode = uEye.Defines.ColorConvertMode.Software;
            }
