...
namespace Measure
{
    ...
    public class XVBAEngine : System.IDisposable
    {
        ...
        private void Init()
        {
            ...
            //添加he命名空间 yoga 2018-9-12 15:34:42
            this.myVBCompilerImports.Add("CPublicDefine");
            ...
            //添加he的dll
            this.myCompilerParameters.ReferencedAssemblies.Add("CPublicDefine.dll");
        }
        public CCalculate P
        {
            get;
                    ...
                    if (this.strCompilerOutput.Length > 0)
                    {
                        ...
                        for (int x = 0; x < result.Errors.Count; x++)
                        {
                            ...
                            strErrorMsg = strErrorMsg + Environment.NewLine +
                                        "第 " + (result.Errors[x].Line - 8).ToString() + " 行:  " +
