...
namespace ViewWindow.Model
{
    ...
    public class HWndCtrl
    {
        ...
        /// <param name="hObj">传入的region.xld,image</param>
        /// <param name="color">颜色</param>
        public void DispObj(MeasureROIText roiText)
        {
            lock (this)
            {
                roiTextList.Add(roiText);
                ShowTool.set_display_font(viewPort.HalconWindow, roiText.size, roiText.font, "false", "false");
                ShowTool.disp_message(viewPort.HalconWindow, roiText.text, "image", roiText.row, roiText.col, roiText.drawColor, "false");
            }
        }
        ...
        private void showHObjectList()
        {
            try
            {
                ...
                foreach (MeasureROIText roiText in roiTextList)
                {
                    ShowTool.set_display_font(viewPort.HalconWindow, roiText.size, roiText.font, "false", "false");
                    ShowTool.disp_message(viewPort.HalconWindow, roiText.text, "image", roiText.row, roiText.col, roiText.drawColor, "false");
                }
