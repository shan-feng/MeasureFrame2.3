    ...
    public partial class HWindow_HE : UserControl
    {
        ...
        private void SaveWindowDump()
        {
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                //截取窗口图
               // HOperatorSet.DumpWindow(HWindowHalconID, "png", sfd.FileName);
                this.mCtrl_HWindow.HalconWindow.DumpWindow("png", sfd.FileName);
            }
        }
        /// <summary>
        /// 保存窗体截图到本地
        ...
        public void SaveWindowDump(string fileName)
        {
            ...
            //截取窗口图
            this.mCtrl_HWindow.HalconWindow.DumpWindow("png", fileName);
        }
        ...
        {
            SaveFileDialog sfd = new SaveFileDialog();
            sfd.Filter = "PNG图像|*.png|BMP图像|*.bmp";
            ...
            if (sfd.ShowDialog() == DialogResult.OK)
            {
                ...
                System.IO.FileInfo _FileInfo = new System.IO.FileInfo(sfd.FileName);
                ...
                switch (_FileInfo.Extension.ToLower())
                {
                    case ".bmp":
                        ...
                        break;
                    case ".png":
                        HOperatorSet.WriteImage(hv_image, "png", 0, sfd.FileName);
                        break;
                }
            }
        }
        ...
        /// </summary>
        /// <param name="he"></param>
        public void showHE(HImageExt he)
        {
            if (he == null)
            {
                return;
            ...
            foreach (MeasureROI roi in he.measureROIlist)
            {
                if (roi != null && roi.roiType == enMeasureROIType.文字显示.ToString())
                {
                    ...
                    lock (this)
                    {
                        viewWindow.displayText(roiText);
                    }
                }
                else
                {
